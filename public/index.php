			...
			<header id="header" class="alt skel-layers-fixed">
				...
				<nav id="nav">
					<ul>
                        ...
                        <li>
                            <a href="" class="icon fa-angle-down">Sign UP</a>
                            <ul onclick="event.stopPropagation();" class="menuform">
                                <li>Email:</li>
                                <li><input type="text" class="head_input" id="reglogin" /></li>
                                <li>Password</li>
                                <li><input type="password" class="head_input" id="regpass" /></li>
                                <li>Password Again</li>
                                <li><input type="password" class="head_input" id="regpass2" /></li>
                                <li><a href="#" class="button special fit" style="line-height: 3.5em;margin-top:10px;">Sign Up</a></li>
                            </ul>
                        </li>
					</ul>
				</nav>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner" align="center">
					<h2>SEOTools</h2>
					<p>Complex Tool for Sete Analytics</p>
                    <input type="text" name="test_url" id="test_url" value="" style="width:40%;" placeholder="http://yoursite.com"/><br>
					<ul class="actions">
						<li><a href="#" class="button big ">Run Test</a></li>
					</ul>
				</div>
			</section>
